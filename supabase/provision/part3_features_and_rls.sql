...
-- 18.00 = the rate the PROPERTY pays us per door, month-to-month (15.00 on a
-- 36-month term, set per property). NOT the resident-facing $25-35 -- the property
-- bills residents itself and keeps the spread. Corrected from 25.00 on 2026-08-21
-- to match migration 20260516000032. See brain/sales/offer.md.
ALTER TABLE public.properties
    ADD COLUMN IF NOT EXISTS monthly_fee_per_door DECIMAL(10, 2) NOT NULL DEFAULT 18.00;
...
COMMENT ON COLUMN public.properties.monthly_fee_per_door IS
    'Monthly amount the PROPERTY pays us per billable door (not the resident-facing fee).';
